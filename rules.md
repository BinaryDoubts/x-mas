...
* TOUGH (take a punch, break down a door, endure suffering)
* QUICK (leap a wall, dodge a sword, sneak past a guard)
* SMART (analyze a situation, sabotage a weapon, know stuff)
* SOCIAL (interrogate an enemy, comfort a civilian, lie fluently)
...
* **1-6: NAUGHTY.** You don’t do what you wanted to do, and things go wrong somehow. 
* **7-9: MOSTLY NICE.** You do what you wanted to, but with a cost, compromise, or complication.
* **10+: NICE.** You do exactly what you wanted to do, without any additional headaches.
* **12+: EXTRA NICE.** You do exactly what you wanted to do, with some spectacular added bonus.
...
* Grant an ally (not yourself) a full re-roll after seeing the result. You must narrate how you assist them, and will take any consequences alongside them. *If the second roll is worse, keep the first result.*
* Protect an ally who's about to get hurt, taking the damage yourself.
* If you're a Christmas Ghost, perform an action that affects the physical world (like shooting your ghost guns or pulling the pin on an enemy's grenade).

Between action scenes, you can also spend one Christmas Spirit to:
* Find a cache of ammo to reload your Heavy Weapon.
* Heal 1 Wound from an ally. If they were On Lethal, they remove the status.

You can gain Christmas Spirit at Command's discretion or by fulfilling one of the conditions below:
- Roleplaying your Guy Type to the hilt by making a suboptimal choice, putting yourself in danger, or just making everyone laugh
- Showing mercy, kindness, and/or the giving spirit to a friend or enemy
- Willingly take -1 to the roll by using a tag in a negative way (generally just Slow or Heavy, but you can be creative)
- Dispatching an enemy after delivering a unique Christmas-themed one-liner
...
* Cannon Fodder: 1 PT (Pain Threshold), 1d4 damage
* Grunt: 3 PT, 1d4+1 damage
* Captain: 4 PT, 1 armor, 1d6 damage
* Elite: 6 PT, 2 armor, 1d6+2 damage 